...
@TestPropertySource(properties = {
        ...
        "workforce.integrations.biometric.enabled=true" })
class BiometricIntegrationControllerTests {

    @Autowired
    private MockMvc mockMvc;

    @Test
    void ingestsClockEventsAndReportsPerEventOutcome() throws Exception {
    ...
    @Test
    void rejectsEmptyEventList() throws Exception {
        mockMvc.perform(post("/api/v1/integrations/biometric/clock-events")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("[]"))
